...
<template>
  <div
    class="relative w-full h-[580px] rounded-2xl mx-auto bg-white border overflow-hidden"
  >
    <div
      ...
      >
        ...
        >
          <span
            ...
            class="inline-block text-warning text-sm"
          >
            {{ message.name }}
          </span>
        ...
        >
          ...
          <span
            class="text-[11px] font-medium text-[#3C3C4399] leading-[13px] px-2"
          >
            {{ message.timeStamp }}
          </span>
        </p>
    ...
    <!-- Input Section -->
    <div
      class="absolute bottom-0 left-0 w-full h-[88px] mt-4 bg-white z-1 border-t pt-3.5 px-6 rounded-b-2xl"
    >
      <div
        class="flex items-center space-x-2 bg-white border p-2 pl-3 rounded-xl"
      >
        <!-- Attatchment icon -->
        <span
          class="h-6 w-6 rounded-sm bg-[#F5FDFF] flex items-center justify-center"
        >
          <Icon name="attach" />
        </span>
